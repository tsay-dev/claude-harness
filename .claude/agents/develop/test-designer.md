...
- **The conventions leaf** `.claude/rules/develop/docs.md` is delivered by its `paths:` when you write a REQ's policy. Read its §6 and §11 before you start.
